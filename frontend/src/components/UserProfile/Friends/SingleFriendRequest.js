  ...
  return (
    ...
    >
      <Row style={{ height: "5rem" }}>
        <Col xs="2">
          <Gravatar
            email={friendRequest.sender__email}
            size={50}
        ...
        >
          <UserNameContainer onClick={navigateToProfile}>
            <UserNameText>{friendRequest.sender__username}</UserNameText>
          </UserNameContainer>
        </Col>
        <Col xs="5" style={{ display: "flex", justifyContent: "flex-end" }}>
          <Row>
            <Col>
              <Button
                onClick={(e) => acceptFriendRequest(friendRequest.sender)}
                style={{
                  borderRadius: "20px",
                  height: "3rem",
                  marginRight: "1rem",
              ...
              <Button
                onClick={(e) => rejectFriendRequest(friendRequest.sender)}
                style={{
                  borderRadius: "20px",
                  height: "3rem",
                  backgroundColor: "red",
