...
describe('User is member', () => {
    ...
    //         //         await waitFor(() => {
    //         //             // screen.getByRole('tab', { name: /feed/i })
    //         //             // fireEvent.click()
    //         //             const title = screen.getByText(/blanditiis velit neque nulla perspiciatis\./i)
