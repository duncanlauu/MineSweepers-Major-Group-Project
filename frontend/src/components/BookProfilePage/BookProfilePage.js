    ...
    return (
        <div>
            ...
            <Container fluid>
                ...
                <Row>
                    <Col>
                    <BookRatingCard id={book_id} image ={book.image_links_large} parentCallBack={handleChange} clearable ={clearable} idReturn={false} initialRating={previousRating.rating}/>
                    <Button
                        type="submit"
                        className="submit"
                        disabled={toggle}
                    ...
                    <CardTitle tag="h1" style={{padding:"1rem"}}>Title: {book.title}</CardTitle>
                    <CardSubtitle tag="h2" style={{padding:"1rem"}}>Author: {book.author}</CardSubtitle>
                    <CardSubtitle tag="h2" style={{padding:"1rem"}}>Date: {book.publication_date}</CardSubtitle>
                    <CardSubtitle tag="h2" style={{padding:"1rem"}}>Genre: {book.genre}</CardSubtitle>
                    <CardSubtitle tag="h2" style={{padding:"1rem"}}>Publisher: {book.publisher}</CardSubtitle>
