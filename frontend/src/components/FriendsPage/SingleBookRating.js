        ...
        <div>
            <BookLine>
                <Row style={{height: "5rem"}} onClick={navigateToBook} >
                    ...
                    <Col xs="2">
                        <img src={book.image_links_small} alt="Book's cover" style={{height: "5rem", width: "5rem"}} />
                    </Col>

                    <Col xs="6" style={{height: "5rem", display: "flex", justifyContent: "center", alignItems: "center", fontSize:"15px"}}>
                                {book.title}
                    </Col>
