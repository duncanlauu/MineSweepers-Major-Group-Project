                  ...
                  <ProfileInfoDetails>
                    ...
                    {user_id !== undefined && (
                      ...
                      >
                        <Button
                          color="primary"
                          onClick={(e) => postFriendRequest(currentUser.id)}
                          style={{ height: "4rem", width: "8rem" }}
                        >
                          <p> Follow </p>
                        </Button>
                        <Button
                          onClick={(e) => cancelFriendRequest(currentUser.id)}
              ...
              <DataContainerCard>
                ...
                <DataContainerBelowTabs>
                  <TabContent activeTab={currentActiveTab}>
                    ...
                    <TabPane tabId="2">
                      {user_id == undefined && <FriendRequestList />}

                      <FriendListContainer>
                        {console.log(
                          "So what user_id are we passing???: " + user_id
                        )}
