...
+ Messaging ( `frontend/src/websocket.js`, `frontend/src/components/Chat`, `app/views/chat_views.py`, `app/routing.py` ) : https://www.youtube.com/playlist?list=PLLRM7ROnmA9EnQmnfTgUzCfzbbnc-oEbZ
