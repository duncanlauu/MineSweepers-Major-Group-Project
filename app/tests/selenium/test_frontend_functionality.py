...
from app.recommender_system.file_management import get_combined_data, get_dataset_from_dataframe, \
    get_trainset_from_dataset, train_model, test_model, dump_trained_model
...
class FrontendFunctionalityTest(LiveServerTestCase):
    """Tests Frontend Functionality using Selenium"""
    ...
    def setUpClass(cls):
        ...
        if(run_headless):
            print(f"Running Headless Selenium Tests")
    ...
    def run_testcase(self, test_case, log_in, url=None):
        """Runs a test case and logs in if necessary"""
        try:
    ...
    def test_everything(self):
        ...
        self.run_testcase(self._test_navbar_create_new_club_post, True, "home")
        ...
        self.run_testcase(self._test_chat_page_contains_correct_number_of_chats, True)
    ...
    def _test_club_profile_contains_correct_information_as_non_member(self):
        if(self.user in self.club_where_non_member.applicants.all()):
            self.club_where_non_member.applicants.remove(self.user)
        ...
        self.browser.find_element(by=By.XPATH, value='//button[.="Profile"]').click()
        self.browser.implicitly_wait(10)
        sleep(5)
    ...
    def _test_club_profile_apply_and_withdraw_application_as_non_member(self):
        ...
        self.browser.find_element(by=By.XPATH, value='//button[.="Apply"]').click()
        self.browser.implicitly_wait(10)
        sleep(2)
        ...
        self.browser.find_element(by=By.XPATH, value='//button[.="Withdraw Application"]').click()
        self.browser.implicitly_wait(10)
        sleep(2)
    ...
    def _test_club_feed_contains_correct_information_as_member(self):
        ...
        self.browser.find_element(by=By.XPATH, value='//button[.="Feed"]').click()
        self.browser.implicitly_wait(10)
        sleep(2)
        body_text = self.browser.find_element(by=By.TAG_NAME, value="body").text
        self.assertTrue("PROFILE" in body_text)
    ...
    def _test_accept_club_applicant_as_admin(self):
        ...
        applicant_user_card.find_element(by=By.XPATH, value='.//button[.="Accept"]').click()
        sleep(1)
    ...
    def _test_reject_club_applicant_as_admin(self):
        ...
        for individual_user_card in individual_user_cards:
            ...
            if("Reject" in individual_user_card_text):
                ...
                break
        applicant_username = applicant_user_card.find_element_by_name("username-text").text
        applicant_user_card.find_element(by=By.XPATH, value='.//button[.="Reject"]').click()
        sleep(1)
        number_of_members_after = self.club_where_admin.members.count()
        number_of_applicants_after = self.club_where_admin.applicants.count()
    ...
    def _test_unban_banned_user_as_admin(self):
        ...
        member_individual_user_card.find_element(by=By.XPATH, value='.//button[.="Unban"]').click()
        sleep(1)
    ...
    def _test_ban_member_as_admin(self):
        ...
        member_individual_user_card.find_element(by=By.XPATH, value='.//button[.="Ban"]').click()
        sleep(1)
        self.browser.get(f"{self.live_server_url}/club_profile/{self.club_where_admin.pk}/")
        number_of_banned_users_after = self.club_where_admin.banned_users.count()
        number_of_members_after = self.club_where_admin.members.count()
    ...
    def _test_ban_admin_as_owner(self):
        ...
        new_banned_user = User.objects.get(username=new_banned_user_username)
        admin_individual_user_card.find_element(by=By.XPATH, value='.//button[.="Ban"]').click()
        sleep(1)
        self.browser.get(f"{self.live_server_url}/club_profile/{self.club.pk}/")
        number_of_banned_users_after = self.club.banned_users.count()
    ...
    def _test_promote_member_to_admin_as_owner(self):
        ...
        member_individual_user_card.find_element(by=By.XPATH, value='.//button[.="Promote"]').click()
        sleep(1)
    ...
    def _test_demote_admin_to_member_as_owner(self):
        ...
        admin_individual_user_card.find_element(by=By.XPATH, value='.//button[.="Demote"]').click()
        sleep(1)
        number_of_admins_after = len(self.club.admins.all())
        number_of_members_after = len(self.club.members.all())
        self.assertEqual(number_of_admins_after, number_of_admins_before - 1)
    ...
    def _test_transfer_ownership_to_admin_and_leave_club(self):
        ...
        admin_individual_user_card.find_element(by=By.XPATH, value='.//button[.="Make Owner"]').click()
        sleep(4)
        ...
        number_of_admins_before = len(self.club.admins.all())
        self.browser.find_element(by=By.XPATH, value='//button[.="Leave Club"]').click()
        sleep(1)   
        number_of_admins_after = len(self.club.admins.all())
        self.assertEqual(number_of_admins_after, number_of_admins_before - 1)
    ...
    def _test_club_meetings_page_contains_correct_information_as_owner(self):
        ...
        self.browser.find_element(by=By.XPATH, value='//button[.="Meetings"]').click()
        self.browser.implicitly_wait(10)
    ...
    def _test_schedule_meeting_as_owner(self):
        club_meetings = Meeting.objects.filter(club=self.club)
        number_of_meetings_before = club_meetings.count()
        self.browser.get(f"{self.live_server_url}/club_profile/{self.club.pk}/")
        self.browser.implicitly_wait(10)
        self.wait_until_element_found('//button[.="Meetings"]')
        self.browser.find_element(by=By.XPATH, value='//button[.="Meetings"]').click()
        self.browser.implicitly_wait(10)
        self.wait_until_element_found('//button[.="Schedule a meeting"]')
        self.browser.find_element(by=By.XPATH, value='//button[.="Schedule a meeting"]').click()
        sleep(2)
        ...
        self.browser.find_element(by=By.XPATH, value='//button[.="Create"]').click()
        sleep(2)
        self.browser.implicitly_wait(20)
        number_of_meetings_after = club_meetings.count()
        self.assertEqual(number_of_meetings_before + 1, number_of_meetings_after)
    ...
    def _test_boogkle_logo_redirects_to_landing_page(self, url):
        ...
        self.browser.find_element(by=By.XPATH, value='//a[.="bookgle"]').click()
        self.browser.implicitly_wait(10)
    ...
    def _test_landing_page_log_in_button(self):
        ...
        self.browser.implicitly_wait(10)
        self.browser.find_element(by=By.XPATH, value="//a[@href='/log_in/']").click()
        self.browser.implicitly_wait(10)
    ...
    def _test_landing_page_sign_up_button(self):
        self.browser.get(f"{self.live_server_url}/")
        self.browser.implicitly_wait(10)
        self.browser.find_element(by=By.XPATH, value="//a[@href='/sign_up/']").click()
        self.browser.implicitly_wait(10)
    ...
    def _text_sign_up_here_button_redirects_to_sign_up(self):
        ...
        self.browser.implicitly_wait(10)
        self.browser.find_element(by=By.XPATH, value='//a[.="here "]').click()
        self.browser.implicitly_wait(10)
        self.wait_until_element_found("//button[.='Sign Up']")
        self.assertEqual(self.browser.current_url, f"{self.live_server_url}/sign_up/")
        self.browser.implicitly_wait(10)
    ...
    def _test_log_in_with_wrong_password(self):
        ...
        self.browser.find_element(by=By.XPATH, value="//button[.='Log In']").click()
        self.browser.implicitly_wait(10)
        sleep(1)
        self.assertEqual(self.browser.current_url, f"{self.live_server_url}/log_in/")
        self.browser.implicitly_wait(10)
    ...
    def _test_forgot_password_button_redirects_to_password_reset(self):
        self.browser.get(f"{self.live_server_url}/log_in/")
        self.browser.implicitly_wait(10)
        self.browser.find_element(by=By.XPATH, value='//a[.="Forgot Password?"]').click()
        self.browser.implicitly_wait(10)
    ...
    def _test_sign_up_with_blank_fields(self):
        ...
        self.browser.find_element(by=By.XPATH, value="//a[@href='/sign_up/']").click()
        self.browser.implicitly_wait(10)
        self.browser.find_element(by=By.XPATH, value='//button[.="Sign Up"]').click()
        self.browser.implicitly_wait(10)
        sleep(1)
    ...
    def _test_sign_up_and_book_rating(self):
        ...
        sleep(2)
        self.browser.find_element(by=By.XPATH, value='//button[.="Finish"]').click()
        self.browser.implicitly_wait(10)
    ...
    def _test_open_and_close_search_bar(self, url):
        ...
        self.browser.implicitly_wait(10)
        sleep(1)
        self.browser.find_element(by=By.XPATH, value="//button[@aria-label='Close']").click()
        self.browser.implicitly_wait(10)
    ...
    def _test_navbar_create_new_post(self, url):
        ...
        self.browser.find_element(by=By.XPATH, value="//img[@alt='New Post Button']").click()
        ...
        self.browser.find_element(by=By.XPATH, value="//button[.='Post!']").click()
        sleep(2)
        number_of_posts_after = Post.objects.count()
        self.assertEqual(number_of_posts_after, number_of_posts_before + 1)
        self.assertEqual(self.browser.current_url, f"{self.live_server_url}/home/")

    def _test_navbar_create_new_club_post(self, url):
        number_of_posts_before = Post.objects.count()
        self.browser.get(f"{self.live_server_url}/{url}")
        self.browser.implicitly_wait(10)
        self.wait_until_element_found("//img[@alt='New Post Button']")
        self.browser.find_element(by=By.XPATH, value="//img[@alt='New Post Button']").click()
        self.wait_until_element_found("//button[.='Post!']")
        self.browser.find_element_by_name("title").send_keys("New Post Title From ")
        self.browser.find_element_by_name("content").send_keys("New Post Content From ")
        club_select = Select(self.browser.find_element(by=By.TAG_NAME, value='select'))
        club_select.select_by_index(1)
        self.browser.find_element(by=By.XPATH, value="//button[.='Post!']").click()
        sleep(2)
        number_of_posts_after = Post.objects.count()
        self.assertEqual(number_of_posts_after, number_of_posts_before + 1)
    ...
    def _test_new_club_button_redirects_to_create_club(self, url):
        self.browser.get(f"{self.live_server_url}/{url}")
        self.browser.implicitly_wait(10)
        self.browser.find_element(by=By.XPATH, value="//img[@alt='New Club Button']").click()
        self.browser.implicitly_wait(10)
    ...
    def _test_open_chat_button(self, url):
        ...
        self.browser.find_element(by=By.XPATH, value="//img[@alt='Open Chats']").click()
        self.browser.implicitly_wait(10)
        sleep(2)
        self.assertEqual(self.browser.current_url, f"{self.live_server_url}/chat/")

    def _test_open_profile_page(self, url): 
        self.browser.get(f"{self.live_server_url}/{url}")
        self.browser.implicitly_wait(10)
        self.wait_until_element_found("//button[@class='dropdown-toggle btn btn-secondary']")
        self.browser.find_element(by=By.XPATH, value="//button[@class='dropdown-toggle btn btn-secondary']").click()
        sleep(3)
        self.browser.implicitly_wait(10)
        self.wait_until_element_found("//a[@href='/user_profile/']")
        self.browser.find_element(by=By.XPATH, value="//a[@href='/user_profile/']").click()
        self.browser.implicitly_wait(10)
        sleep(2)
        self.assertEqual(self.browser.current_url, f"{self.live_server_url}/user_profile/")

    def _test_log_out_button(self, url): 
        self.browser.get(f"{self.live_server_url}/{url}")
        self.browser.implicitly_wait(10)
        self.wait_until_element_found("//button[@class='dropdown-toggle btn btn-secondary']")
        self.browser.find_element(by=By.XPATH, value="//button[@class='dropdown-toggle btn btn-secondary']").click()
        ...
        self.browser.find_element(by=By.XPATH, value="//a[@href='/log_out/']").click()
        self.browser.implicitly_wait(10)
        sleep(2)
        self.assertEqual(self.browser.current_url, f"{self.live_server_url}/")
    ...
    def _test_open_meetings_page(self, url):
        ...
        self.browser.find_element(by=By.XPATH, value="//a[@href='/meetings/']").click()
        self.browser.implicitly_wait(10)
        sleep(2)
    ...
    def _test_reply_to_comment_on_post(self):
        ...
        first_comment.find_element(by=By.XPATH, value=".//button[@data-testid='comment-reply-button']").click()
        self.browser.implicitly_wait(10)
        sleep(1)
        first_comment.find_element_by_name("myReply").send_keys("New Reply To Comment")
        first_comment.find_element(by=By.XPATH, value="//img[@alt='Post Reply']").click()
        self.browser.implicitly_wait(10)
        sleep(5)
    ...
    def _test_comment_on_post(self):
        ...
        send_buttons = first_post.find_elements_by_xpath("//img[@alt='Post Comment']")
    ...
    def _test_home_page_recommended_book(self):
        ...
        recommended_book_url = recommended_book.find_element(by=By.TAG_NAME, value="a")
    ...
    def _test_create_club(self, url):
        ...
        sleep(2)
        create_club_button = self.browser.find_element(by=By.XPATH, value="//button[.='Create']")
        self.browser.implicitly_wait(10)
    ...
    def _test_all_clubs_page_contains_all_clubs(self):
        ...
        for club_card in club_cards:
            ...
            club_object_total_members = club_object.members.count() + club_object.admins.count() + 1
            self.assertEqual(club_card_club_name, club_object.name)
            self.assertEqual(club_card_number_of_members, club_object_total_members)
    ...
    def _test_search_bar_find_user(self, url):
        ...
        self.browser.find_element(by=By.XPATH, value="//text[.='%s']" % user.username).click()
        sleep(3) 
    ...
    def _test_search_bar_find_club(self, url):
        ...
        self.browser.find_element(by=By.XPATH, value="//text[.='%s']" % club_name).click()
        sleep(3) 
    ...
    def _test_search_bar_find_book(self, url):
        ...
        self.browser.find_element(by=By.XPATH, value="//text[.='%s']" % book_name).click()
        sleep(3)
        self.assertEqual(self.browser.current_url, f"{self.live_server_url}/book_profile/{self.book.pk}/")

    def _test_user_profile_posts_tab_contains_correct_information(self):
        self.browser.get(f"{self.live_server_url}/user_profile")
        self.browser.find_element(by=By.XPATH, value="//text[.='Posts']").click()
    ...
    def _test_edit_user_profile(self):
        ...
        self.browser.implicitly_wait(15)
        self.wait_until_element_found("//button[.='Edit Profile']")
        self.browser.find_element(by=By.XPATH, value="//button[.='Edit Profile']").click()
        ...
        self.browser.find_element(by=By.XPATH, value="//button[.='Save changes']").click()
        sleep(2)
    ...
    def _test_delete_friend(self):
        ...
        self.browser.get(f"{self.live_server_url}/user_profile")
        self.browser.implicitly_wait(10)
        self.browser.find_element(by=By.XPATH, value="//text[.='Friends']").click()
        self.browser.implicitly_wait(10)
        sleep(1)
        self.wait_until_element_found("//div[@class='friend']")
        friend_card = self.browser.find_element(by=By.XPATH, value="//div[@class='friend']")
        friend_card.find_element(by=By.XPATH, value=".//button[.='X']").click() 
        sleep(2)
        self.assertEqual(self.browser.current_url, f"{self.live_server_url}/user_profile/")
    ...
    def _test_accept_friend_request(self):
        ...
        sleep(1)
        self.browser.find_element(by=By.XPATH, value="//p[.=' Accept ']").click()
        sleep(1)
        self.assertEqual(self.browser.current_url, f"{self.live_server_url}/user_profile/")
    ...
    def _test_reject_friend_request(self):
        ...
        self.browser.find_element_by_id("friendRequestToggler").click()
        sleep(1)
        self.browser.find_element(by=By.XPATH, value="//p[.=' Reject ']").click()
        sleep(2)
        self.assertEqual(self.browser.current_url, f"{self.live_server_url}/user_profile/")
        number_of_friend_requests_after = FriendRequest.objects.count()
        number_of_friends_after = len(self.user.friends.all())
    ...
    def _test_edit_post(self):
        ...
        self.browser.find_element(by=By.XPATH, value="//button[.='Edit']").click()
        self.browser.find_element_by_name("title").send_keys(" Edited.")
        self.browser.find_element_by_name("content").send_keys(" Edited.")
        self.browser.find_element(by=By.XPATH, value="//button[.='Save']").click()
        sleep(2)
        self.wait_until_element_found('//div[@class="personalPost"]')
        self.assertEqual(self.browser.current_url, f"{self.live_server_url}/user_profile/")
        body_text = self.browser.find_element(by=By.TAG_NAME, value="body").text
    ...
    def _test_delete_post(self):
        ...
        post_card.find_element(by=By.XPATH, value=".//button[.='X']").click()
        sleep(2)
        self.assertEqual(self.browser.current_url, f"{self.live_server_url}/user_profile/")
        number_of_posts_after = Post.objects.count()
    ...
    def _test_chat_page_contains_correct_number_of_chats(self):
        all_user_chats = self.user.chats.all()
        self.browser.get(f"{self.live_server_url}/chat/")
        all_contacts = self.browser.find_elements_by_xpath("//a[@test-name='contact-card']")
        self.assertEqual(len(all_contacts), len(all_user_chats))
    ...
    def _test_password_reset(self):
        ...
        self.browser.find_element(by=By.XPATH, value='//button[.="Send Reset Email"]').click()
        ...
        self.browser.find_element(by=By.XPATH, value='//a[.="Landing page"]').click()
        self.wait_until_element_found("//a[@href='/log_in/']")
        self.assertEqual(self.browser.current_url, f"{self.live_server_url}/")
        sleep(1)
        ...
        self.browser.find_element(by=By.XPATH, value='//button[.="Reset"]').click() 
        self.wait_until_element_found("//button[.='Log In']")
        self.assertEqual(self.browser.current_url, f"{self.live_server_url}/log_in/")
        self.browser.find_element_by_name("username").send_keys(self.login_data['username'])
        self.browser.find_element_by_name("password").send_keys(new_password)
    ...
    def _log_in(self):
        ...
        self.browser.implicitly_wait(10)
        self.wait_until_element_found("//button[.='Log In']")
        log_in_button = self.browser.find_element(by=By.XPATH, value="//button[.='Log In']")
    ...
    def wait_until_element_found(self, xpath, time=15):
        WebDriverWait(self.browser, timeout=time).until(
            lambda x: self.browser.find_element(by=By.XPATH, value=xpath)
        )
