...
class RejectApplicantViewTestCase(TestCase, LogInTester):
    ...
    def test_reject_applicant_with_owner_permissions(self):
    ...
    def test_reject_applicant_with_admin_permissions(self):
    ...
    def test_reject_applicant_with_member_permissions(self):
    ...
    def test_reject_applicant_with_no_permissions(self):
    ...
    # def test_reject_applicant_with_invalid_applicant_id(self):
    #     pass
    #
    # def test_reject_applicant_with_invalid_club_id(self):
    #     pass