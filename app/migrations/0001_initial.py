# Generated by Django 3.2.5 on 2022-01-29 16:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.book')),
                ('event_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.clubevent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('club_event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.clubevent')),
        ...
        migrations.AddField(
            ...
            name='voting_time',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.vote'),
        ),
        migrations.CreateModel(
            name='BookRatings',
            fields=[
